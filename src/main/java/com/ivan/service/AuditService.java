...
public interface AuditService {
     ...
     *
     * @param athleteLogin The login of the athlete to get audit records for.
     */
    List<Audit> getAllAuditsByAthleteLogin(String athleteLogin);

    /**
     * Records an audit action performed by an athlete.
     *
     * @param actionType The type of action that was performed.
     * @param athleteLogin The login of the athlete who performed the action.
     */
    void audit(ActionType actionType, String athleteLogin);
}