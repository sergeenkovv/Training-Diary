...
@WebServlet("/api/client/training/show-by-sets-amount")
public class ShowTrainingServletBySetsAmountServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws IOException {
        ...
        if (authentication.isAuth()) {
            try {
                viewTrainingBySetsAmount(req, resp, authentication);
    ...
    private void viewTrainingBySetsAmount(HttpServletRequest req, HttpServletResponse resp, Authentication authentication) throws ValidationParametersException, IOException {
