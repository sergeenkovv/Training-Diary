 ...
 * Extends {@link GeneralRepository} with key type {@link Long} and entity type {@link Athlete}.
 *
 * @author sergeenkovv
 */
public interface AthleteRepository extends GeneralRepository<Long, Athlete> {
