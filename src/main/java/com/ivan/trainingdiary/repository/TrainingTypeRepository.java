 ...
 * Extends {@link GeneralRepository} with key type {@link Long} and entity type {@link TrainingType}.
 *
 * @author sergeenkovv
 */
public interface TrainingTypeRepository extends GeneralRepository<Long, TrainingType> {
